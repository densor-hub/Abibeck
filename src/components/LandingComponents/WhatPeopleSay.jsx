...
const WhatPeopleSay = () => {
  return (
    <main className="overflow-x-hidden bg-white pb-[30px]" id="reviews">
      ...
      <section className="block sm:flex w-fit mx-auto">
        <div className="px-3 pb-6 sm:pb-0">
          ...
          <div className="text-[11px] max-w-[200px]">
            ...
            solution that corresponded with a Hospital management application i
            requested. All processes are now seamlessly effective
          </div>
        </div>
